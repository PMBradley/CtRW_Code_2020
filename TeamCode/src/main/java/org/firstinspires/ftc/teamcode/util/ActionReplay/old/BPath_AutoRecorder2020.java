...
@TeleOp(name = "B Path AutoRecorder2020", group = "@@A")

@Config
public class BPath_AutoRecorder2020 extends LinearOpMode{
    // TeleOp Variables

    // Robot Name - Feel free to set it to whatever suits your creative fancy :)
    String robotName = "Lil' ring flinga";
    public static String REPLAY_FILE_NAME = "AutoPathB.bin";
