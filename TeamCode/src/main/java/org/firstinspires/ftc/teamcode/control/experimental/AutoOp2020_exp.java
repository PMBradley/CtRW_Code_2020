...
public class AutoOp2020_exp extends LinearOpMode {
    ...
    public static TargetDrivePosition powershot3Position = new TargetDrivePosition(-6.4, 6, Math.toRadians(15.2));
    ...
    public static TargetDrivePosition stackPickupPos = new TargetDrivePosition(-28, 2, Math.toRadians(-160.0));
