...
public class AutoOp2020_exp extends LinearOpMode {
    ...
    public static TargetDrivePosition lineShootPos = new TargetDrivePosition(-7, -2.0, Math.toRadians(0.0));
    ...
    public static TargetDrivePosition stackPickupPos = new TargetDrivePosition(-30, 1, Math.toRadians(-160.0));
