...
public class TeleOp2020_FieldRelative_Fixed extends LinearOpMode{
    ...
    public static double FIRST_POWERSHOT_RIGHT_DISTANCE = 9.0;
    public static double SECOND_POWERSHOT_RIGHT_DISTANCE = 9.0;
    public static double THIRD_POWERSHOT_RIGHT_DISTANCE = 8.0;
