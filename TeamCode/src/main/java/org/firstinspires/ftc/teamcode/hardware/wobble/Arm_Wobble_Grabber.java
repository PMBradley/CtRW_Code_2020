...
public class Arm_Wobble_Grabber {
    ...
    private static final double ENCODER_TICS_PER_REVOLUTION = 134.4; // the number of encoder tics measured per revolution of the motor used (see the manufacturer website for info)
